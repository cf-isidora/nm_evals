...
MANUAL_FILE_PATH = os.path.join(DATA_DIR, "CF Terminology Management Manual_en excerpts (translated by ChatGPT).txt")
...
CF_INTERNAL_RESOURCES = {
    ...
    "cf_master_marketing": {
        ...
        "local_file": os.path.join(DATA_DIR, "MAIN MARKETING TRANSLATIONS (MMT - Source of Truth).xlsx"),
...
def get_resources_for_direction(direction: str) -> List[Dict]:
    ...
    if direction.upper() == "KO-EN":
        ...
        priorities = [
            ...
            "teamwork", "terminology_depository", "tm_depository", "lucid_tm",
            # Netflix resources
            "noc", "mmt", "ratings_trackers", "lrt", "lego",
            # External verification
            "nikl_romanization", "kofic_kobiz", "romanization_converter", "kmdb", "youtube", "imdb"
        ]
        ...
        priorities = [
            ...
            "teamwork", "terminology_depository", "tm_depository", "lucid_tm",
            # Netflix resources
            "tiloc", "noc", "mmt", "ratings_trackers", "nf_service", "lrt",
            # External verification
            "nikl", "nikl_examples", "kmrb", "cambridge_dictionary", "youtube", "imdb"
        ]
    else:
