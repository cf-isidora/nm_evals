...
def verify_name_in_teamwork(name: str) -> Dict[str, Any]:
    ...
    try:
        ...
        response = requests.get("https://cultureflipper.teamwork.com/projects.json", headers=headers)
    ...
    try:
        ...
        if previous_evaluations:
            ...
            verification_status = "Prior translations found - detailed verification needed"
        else:
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("Usage: python teamwork_integration.py [search|evaluations|verify|post] [name]")
        sys.exit(1)
    ...
    if command == "search" and name:
        ...
        try:
            ...
            success, message = post_evaluation_to_teamwork(name, sample_eval, project_id=project_id)
